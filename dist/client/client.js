...
/***/ "./src/jobs/phone/client.ts":
/*!**********************************!*\
  !*** ./src/jobs/phone/client.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   PhoneClient: () => (/* binding */ PhoneClient)\n/* harmony export */ });\n/* harmony import */ var _types_AbstractJob__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../types/AbstractJob */ \"./src/jobs/types/AbstractJob.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\nclass PhoneClient extends _types_AbstractJob__WEBPACK_IMPORTED_MODULE_0__.AbstractJob {\n    constructor() {\n        super(...arguments);\n        this.isOpen = false;\n    }\n    onInit() {\n        try {\n            this.registerCommands();\n        }\n        catch (error) {\n            console.error(error);\n        }\n    }\n    registerCommands() {\n        try {\n            RegisterKeyMapping('@phone:open-close', 'Ouvrir/Fermer le téléphone', 'keyboard', 'K');\n            RegisterCommand('@phone:open-close', () => __awaiter(this, void 0, void 0, function* () {\n                if (this.isOpen) {\n                    this.isOpen = false;\n                    SetNuiFocus(false, false);\n                    SendNUIMessage({\n                        action: 'phone:close',\n                    });\n                }\n                else {\n                    this.isOpen = true;\n                    SetNuiFocus(true, true);\n                    SetNuiFocusKeepInput(true);\n                    SendNUIMessage({\n                        action: 'phone:open',\n                    });\n                }\n            }), false);\n        }\n        catch (error) {\n            console.error(`Erreur lors de l'enregistrement des commandes:`, error);\n        }\n    }\n}\n\n\n//# sourceURL=webpack://persona-core/./src/jobs/phone/client.ts?");
